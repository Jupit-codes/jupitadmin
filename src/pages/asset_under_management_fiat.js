...
export default function Assetundermanagementfiat() {
  ...
  const isUserNotFound = filteredUsers.length === 0;
    ...
    await axios({
        ...
        url:`${BaseUrl}/admin/get/fiatasset/set`,
        method:'POST',
        headers:{
  ...
  return (
    <Page title="Asset Under Management Fiat">
      <Container>
        <Stack direction="row" alignItems="center" justifyContent="space-between" mb={5} mt={5}>
          <Typography variant="h4" gutterBottom>
            Asset Under Management Fiat
          </Typography>
          {/* <Button variant="contained" component={RouterLink} t[o="#" startIcon={<Iconify icon="clarity:export-line" />}>
            Test
          </Button> */}
        </Stack>
        <Grid item xs={12} md={6} lg={8} sx={{mt:"2rem"}}>
            <Grid container spacing={1}>
                <Grid item xs={12} sm={6} md={4}>
                        <AppWidgetSummaryEdit title="Total Fiat" color="primary" total={nairabalance} icon={'tabler:currency-naira'}   refreshPage={setrefresh} refresh={refresh}/>
                    </Grid>
